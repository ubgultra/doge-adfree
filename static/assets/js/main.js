...
if(window.location.pathname === "/index.html" || window.location.pathname === "/") {
  ...
  const options = ["youve got a serious skill issue, get that checked", "youve got a serious skill issue, get that checked", "youve got a serious skill issue, get that checked", "Have you prayed today? Cause if not im gonna eat yo-", "Tab Cloaking is unhighly recommended", "STOP PIGGYBACKING OFF NATEPROX BRUH", "This version of this site was originally to f-", "Hosted on the best hardware!", "Do not share this link with anyone.", "Join our Discord for more cool things!", "Join our Discord for more cool things!", "©2024 Doge Network. All Rights Reserved.", "Customize Doge by going to Settings > Themes", "Want more links? Our Discord provides tons of links!", "Hi, fowntain here!", "Thank you so much for 10,000 Discord members! 🎉", "Thank you so much for 10,000 Discord members! 🎉", "Thank you so much for 10,000 Discord members! 🎉", ];
